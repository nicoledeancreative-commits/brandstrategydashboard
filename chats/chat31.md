# HTML download to Claudecode

_Started 2026-07-22 17:40 UTC_

---

## User

Can I download this as an html file and bring it into claudecode?

## User

Can I use it without connecting it to a github? Especially if saving is involved?
...
no sirry I mean the app experience
...
No GitHub needed for that either. Claude Code works directly on local files — you point it at the unzipped folder and it builds/runs the app from there. Saving/persistence just depends on what you implement (localStorage, a database, etc.), not on GitHub. GitHub only matters later if you want version history or to deploy/share the repo.
...
Confirms: `image-slot.js` is a required local dependency too. Building the full package now.
...
Now verifying the exported package actually renders and the interactions work.
